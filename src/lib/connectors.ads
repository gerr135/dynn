-- This package implements a commonly used topological construct of 1-to-many connections.
-- The semantics are similar throughout, even if connection designation may have different meaning,
-- so it makes sense to have a single common package for all such instances.
--
-- NOTE: duplicate connections a re prohibited.
--
